#' Survey Level EEI project 2022
#'
#' This survey aimed to assess the retail investor demand and market potential for green/sustainable financial solutions in six EU countries. It is structured in 9 parts:A Interest in sustainable finance products, B Believes abouts sustainable finance products, C Sustainability objectives in relation to financial objectives, D Interst and preferences about voting , E+F Investments in and preferences for green financial products, G Interest in innovative green financial products (e.g. PE or infrastructure funds) , H Interest in green borrowing (e.g. green loans or energy performance contracts), I Sociodemographic profile.
#'
#' @format A tibble with 6105 rows and 423 variables:
#' \describe{
...
#'   \item{A4_hidr1_BE}{Less than â‚¬900}
#'   \item{A4_hidr2_BE}{â‚¬900 - â‚¬1,300 per month}
#'   \item{A4_hidr3_BE}{â‚¬1,301 - â‚¬2,000 per month}
#'   \item{A4_hidr4_BE}{â‚¬2,001 - â‚¬2,600 per month}
#'   \item{A4_hidr5_BE}{â‚¬2,601 - â‚¬3,200 per month}
#'   \item{A4_hidr6_BE}{â‚¬3,201 - â‚¬4,500 per month}
#'   \item{A4_hidr7_BE}{More than â‚¬4,500 per month}
#'   \item{A4_hidr8_BE}{I don't want to answer}
#'   \item{A4_hidr1_ES}{Less than â‚¬900}
#'   \item{A4_hidr2_ES}{â‚¬900 - â‚¬1,300 per month}
#'   \item{A4_hidr3_ES}{â‚¬1,301 - â‚¬2,000 per month}
#'   \item{A4_hidr4_ES}{â‚¬2,001 - â‚¬2,600 per month}
#'   \item{A4_hidr5_ES}{â‚¬2,601 - â‚¬3,200 per month}
#'   \item{A4_hidr6_ES}{â‚¬3,201 - â‚¬4,500 per month}
#'   \item{A4_hidr7_ES}{More than â‚¬4,500 per month}
#'   \item{A4_hidr8_ES}{I don't want to answer}
#'   \item{A4_hidr1_IT}{Less than â‚¬900}
#'   \item{A4_hidr2_IT}{â‚¬900 - â‚¬1,300 per month}
#'   \item{A4_hidr3_IT}{â‚¬1,301 - â‚¬2,000 per month}
#'   \item{A4_hidr4_IT}{â‚¬2,001 - â‚¬2,600 per month}
#'   \item{A4_hidr5_IT}{â‚¬2,601 - â‚¬3,200 per month}
#'   \item{A4_hidr6_IT}{â‚¬3,201 - â‚¬4,500 per month}
#'   \item{A4_hidr7_IT}{More than â‚¬4,500 per month}
#'   \item{A4_hidr8_IT}{I don't want to answer}
#'   \item{A4_hidr1_NE}{Less than â‚¬900}
#'   \item{A4_hidr2_NE}{â‚¬900 - â‚¬1,300 per month}
#'   \item{A4_hidr3_NE}{â‚¬1,301 - â‚¬2,000 per month}
#'   \item{A4_hidr4_NE}{â‚¬2,001 - â‚¬2,600 per month}
#'   \item{A4_hidr5_NE}{â‚¬2,601 - â‚¬3,200 per month}
#'   \item{A4_hidr6_NE}{â‚¬3,201 - â‚¬4,500 per month}
#'   \item{A4_hidr7_NE}{More than â‚¬4,500 per month}
#'   \item{A4_hidr8_NE}{I don't want to answer}
#'   \item{A4_hidr1_PL}{Less than 2,000 zÅ‚}
#'   \item{A4_hidr2_PL}{2,001 zÅ‚ - 3,000 zÅ‚ per month}
#'   \item{A4_hidr3_PL}{3,001 zÅ‚ - 5,000 zÅ‚ per month}
#'   \item{A4_hidr4_PL}{5,001 zÅ‚ - 6,200 zÅ‚ per month}
#'   \item{A4_hidr5_PL}{6,201 zÅ‚ - 7,700 zÅ‚ per month}
#'   \item{A4_hidr6_PL}{7,701 zÅ‚ - 11,000 zÅ‚ per month}
#'   \item{A4_hidr7_PL}{More than 11,000 zÅ‚ per month}
#'   \item{A4_hidr8_PL}{I don't want to answer}
#'   \item{A4_hidr1_SW}{Less than 10,000 kr}
#'   \item{A4_hidr2_SW}{10,001 kr - 14,000 kr per month}
#'   \item{A4_hidr3_SW}{14,001 kr - 22,000 kr per month}
#'   \item{A4_hidr4_SW}{22,001 kr - 28,000 kr per month}
#'   \item{A4_hidr5_SW}{28,001 kr - 35,000 kr per month}
#'   \item{A4_hidr6_SW}{35,001 kr - 50,000 kr per month}
#'   \item{A4_hidr7_SW}{More than 50,000 kr per month}
#'   \item{A4_hidr8_SW}{I don't want to answer}
...
#'   \item{A5_hidr1_BE}{I do not save}
#'   \item{A5_hidr2_BE}{Up to 49â‚¬ per month}
#'   \item{A5_hidr3_BE}{50â‚¬ - 149â‚¬ per month}
#'   \item{A5_hidr4_BE}{150â‚¬ - 249â‚¬ per month}
#'   \item{A5_hidr5_BE}{250â‚¬ - 349â‚¬ per month}
#'   \item{A5_hidr6_BE}{350â‚¬ - 500â‚¬ per month}
#'   \item{A5_hidr7_BE}{More than 500â‚¬ per month}
#'   \item{A5_hidr8_BE}{I don't want to answer}
#'   \item{A5_hidr1_ES}{I do not save}
#'   \item{A5_hidr2_ES}{Up to 49â‚¬ per month}
#'   \item{A5_hidr3_ES}{50â‚¬ - 149â‚¬ per month}
#'   \item{A5_hidr4_ES}{150â‚¬ - 249â‚¬ per month}
#'   \item{A5_hidr5_ES}{250â‚¬ - 349â‚¬ per month}
#'   \item{A5_hidr6_ES}{350â‚¬ - 500â‚¬ per month}
#'   \item{A5_hidr7_ES}{More than 500â‚¬ per month}
#'   \item{A5_hidr8_ES}{I don't want to answer}
#'   \item{A5_hidr1_IT}{I do not save}
#'   \item{A5_hidr2_IT}{Up to 49â‚¬ per month}
#'   \item{A5_hidr3_IT}{50â‚¬ - 149â‚¬ per month}
#'   \item{A5_hidr4_IT}{150â‚¬ - 249â‚¬ per month}
#'   \item{A5_hidr5_IT}{250â‚¬ - 349â‚¬ per month}
#'   \item{A5_hidr6_IT}{350â‚¬ - 500â‚¬ per month}
#'   \item{A5_hidr7_IT}{More than 500â‚¬ per month}
#'   \item{A5_hidr8_IT}{I don't want to answer}
#'   \item{A5_hidr1_NE}{I do not save}
#'   \item{A5_hidr2_NE}{Up to 49â‚¬ per month}
#'   \item{A5_hidr3_NE}{50â‚¬ - 149â‚¬ per month}
#'   \item{A5_hidr4_NE}{150â‚¬ - 249â‚¬ per month}
#'   \item{A5_hidr5_NE}{250â‚¬ - 349â‚¬ per month}
#'   \item{A5_hidr6_NE}{350â‚¬ - 500â‚¬ per month}
#'   \item{A5_hidr7_NE}{More than 500â‚¬ per month}
#'   \item{A5_hidr8_NE}{I don't want to answer}
#'   \item{A5_hidr1_PL}{I do not save}
#'   \item{A5_hidr2_PL}{Up to 149 zÅ‚ per month}
#'   \item{A5_hidr3_PL}{150 zÅ‚ - 399 zÅ‚ per month}
#'   \item{A5_hidr4_PL}{400 zÅ‚ - 699 zÅ‚ per month}
#'   \item{A5_hidr5_PL}{700 zÅ‚ - 999 zÅ‚ per month}
#'   \item{A5_hidr6_PL}{1000 zÅ‚ - 1,399 zÅ‚ per month}
#'   \item{A5_hidr7_PL}{More than 1,400 zÅ‚ per month}
#'   \item{A5_hidr8_PL}{I don't want to answer}
#'   \item{A5_hidr1_SW}{I do not save}
#'   \item{A5_hidr2_SW}{Up to 599 kr per month}
#'   \item{A5_hidr3_SW}{600 kr - 1,799 kr per month}
#'   \item{A5_hidr4_SW}{1,800 kr - 2,799 kr per month}
#'   \item{A5_hidr5_SW}{2,800 kr - 3,899 kr per month}
#'   \item{A5_hidr6_SW}{3,900 kr - 5,500 kr per month}
#'   \item{A5_hidr7_SW}{More than 5,500 kr per month}
#'   \item{A5_hidr8_SW}{I don't want to answer}
...
#'   \item{A6_hidr1_BE}{Up to â‚¬2500}
#'   \item{A6_hidr2_BE}{From â‚¬2,501 to â‚¬25,000}
#'   \item{A6_hidr3_BE}{From â‚¬25,001 to â‚¬50,000}
#'   \item{A6_hidr4_BE}{From â‚¬50,001 to â‚¬100,000}
#'   \item{A6_hidr5_BE}{From â‚¬100,001 to â‚¬200,000}
#'   \item{A6_hidr6_BE}{From â‚¬200,001 to â‚¬500,000}
#'   \item{A6_hidr7_BE}{Above â‚¬500,000}
#'   \item{A6_hidr8_BE}{I don't want to answer}
#'   \item{A6_hidr1_ES}{Up to â‚¬2500}
#'   \item{A6_hidr2_ES}{From â‚¬2,501 to â‚¬25,000}
#'   \item{A6_hidr3_ES}{From â‚¬25,001 to â‚¬50,000}
#'   \item{A6_hidr4_ES}{From â‚¬50,001 to â‚¬100,000}
#'   \item{A6_hidr5_ES}{From â‚¬100,001 to â‚¬200,000}
#'   \item{A6_hidr6_ES}{From â‚¬200,001 to â‚¬500,000}
#'   \item{A6_hidr7_ES}{Above â‚¬500,000}
#'   \item{A6_hidr8_ES}{I don't want to answer}
#'   \item{A6_hidr1_IT}{Up to â‚¬2500}
#'   \item{A6_hidr2_IT}{From â‚¬2,501 to â‚¬25,000}
#'   \item{A6_hidr3_IT}{From â‚¬25,001 to â‚¬50,000}
#'   \item{A6_hidr4_IT}{From â‚¬50,001 to â‚¬100,000}
#'   \item{A6_hidr5_IT}{From â‚¬100,001 to â‚¬200,000}
#'   \item{A6_hidr6_IT}{From â‚¬200,001 to â‚¬500,000}
#'   \item{A6_hidr7_IT}{Above â‚¬500,000}
#'   \item{A6_hidr8_IT}{I don't want to answer}
#'   \item{A6_hidr1_NE}{Up to â‚¬2500}
#'   \item{A6_hidr2_NE}{From â‚¬2,501 to â‚¬25,000}
#'   \item{A6_hidr3_NE}{From â‚¬25,001 to â‚¬50,000}
#'   \item{A6_hidr4_NE}{From â‚¬50,001 to â‚¬100,000}
#'   \item{A6_hidr5_NE}{From â‚¬100,001 to â‚¬200,000}
#'   \item{A6_hidr6_NE}{From â‚¬200,001 to â‚¬500,000}
#'   \item{A6_hidr7_NE}{Above â‚¬500,000}
#'   \item{A6_hidr8_NE}{I don't want to answer}
#'   \item{A6_hidr1_PL}{Up to 6,000 zÅ‚}
#'   \item{A6_hidr2_PL}{From 6,001 zÅ‚ to 60,000 zÅ‚}
#'   \item{A6_hidr3_PL}{From 60,001 zÅ‚ to 120,000 zÅ‚}
#'   \item{A6_hidr4_PL}{From 120,001 zÅ‚ to 240,000 zÅ‚}
#'   \item{A6_hidr5_PL}{From 240,001 zÅ‚ to 480,000 zÅ‚}
#'   \item{A6_hidr6_PL}{From 480,001 zÅ‚ to 1,200,000 zÅ‚}
#'   \item{A6_hidr7_PL}{Above 1,200,000 zÅ‚}
#'   \item{A6_hidr8_PL}{I don't want to answer}
#'   \item{A6_hidr1_SW}{Up to 30,000 kr}
#'   \item{A6_hidr2_SW}{From 30,001 kr to 275,000 kr}
#'   \item{A6_hidr3_SW}{From 275,001 kr to 550,000 kr}
#'   \item{A6_hidr4_SW}{From 550,001 kr to 1,100,000 kr}
#'   \item{A6_hidr5_SW}{From 1,100,001 kr to 2,200,000 kr}
#'   \item{A6_hidr6_SW}{From 2,200,001 kr to 5,500,000 kr}
#'   \item{A6_hidr7_SW}{Above 5,500,000 kr}
#'   \item{A6_hidr8_SW}{I don't want to answer}
...
#'   \item{B2}{ Please continue the following sentence I believe that, in general, introducing sustainability factors into an investment strategyâ€¦}
...
#'   \item{J1}{ Some banks are currently proposing loans to households at cheaper interest rates to finance green projects with clear environmental benefits like â€¢ the purchase of an electric car, â€¢ the switch to energy-efficient heating devices, â€¢ the energy-efficient retrofitting of homes, â€¢ the installation of solar panels or small-scall wind turbines in homes Have you personally used such green loan facilities?}
