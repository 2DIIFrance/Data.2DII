...
#'   \item{pagetimeQ2Ax5}{(Q2Ax5) You have chosen more than one sustainability objective. Please rank their priority in the order you would like to have them implemented for your primary financial goal: [pipe: hidxQ2Ax5pipe]}
...
#'   \item{pagetimeQ2Bx5}{(Q2Bx5) If you could exclude companies who are involved in certain environmental activities from your investments, how important would it be to you to exclude the following activities[pipe: hidxPipeQ2Bx5]?}
#'   \item{pagetimeQ2Bx6}{(Q2Bx6) If you could exclude companies who are involved in certain social activities from your investments, how important would it be to you to exclude the following activities[pipe: hidxPipeQ2Bx5]?}
#'   \item{pagetimeQ2Bx7}{(Q2Bx7) If you could exclude companies who are involved in certain activities from your investments on ethical grounds, how important would it be to you to exclude the following activities[pipe: hidxPipeQ2Bx5]?}
#'   \item{pagetimeQ2Bx8}{(Q2Bx8) If you could exclude companies who are involved in certain governance activities from your investments, how important would it be to you to exclude the following activities[pipe: hidxPipeQ2Bx8]?}
